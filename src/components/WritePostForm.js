...
import {getCategoryDetail, getCategoryList, getPostDetail} from "../apis/apis";
...
class WritePostForm extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (post_id) {
            ...
            const category = await getCategoryDetail(postDetail.category_id)
        ...
        if (category_id) {
            const category = await getCategoryDetail(category_id)
